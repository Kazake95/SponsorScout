...
_CLOUDFLARE_MARKERS = [
    ...
    "/_cf/challenge-platform/",     # CF Turnstile widget script path
    "challenges.cloudflare.com",    # Turnstile / managed challenge CDN
    "__cf_chl_opt",                 # CF challenge page JS var
    "cf-wrapper",                   # CF page wrapper div
]

...
LANGUAGES: dict[str, dict[str, str]] = {
    ...
    "it": {
        ...
        "Select a job, then click 'Rate this job'.":
            "Seleziona un lavoro, poi clicca 'Valuta questo lavoro'.",
        ...
        "Contacting Gemini API...": "Connessione all'API Gemini...",
        "Contacting custom AI endpoint...": "Connessione all'endpoint AI personalizzato...",
        "Contacting {provider} OpenAI-compatible API...":
            "Connessione all'API {provider} compatibile OpenAI...",
